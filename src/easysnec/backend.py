...
from .utils.grading import COURSES, SuccessStatus, InputData
...
class BackendInterface(QObject):
    ...
    selectedPort = Property(
        str, get_selected_port, set_selected_port, notify=selectedPortChanged
